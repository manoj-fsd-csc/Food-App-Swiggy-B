...
function CheckOut() {
  ...
  const [firmImage, setFirmImage] = useState([]);
   const { clickedProducts, updateProductQuantity,updateTotalCost } = useContext(ProductContext);
  ...
  const handleIncrease = (productId) => {
    updateProductQuantity(productId, (clickedProducts[productId]?.quantity || 0) + 1);
  };

  const handleDecrease = (productId) => {
    updateProductQuantity(productId, Math.max((clickedProducts[productId]?.quantity || 0) - 1, 0));
  };
  ...
  const platformFee = Object.values(clickedProducts).reduce((total, product) => {
...
useEffect(() => {updateTotalCost(totalItemCost);
 }, [totalItemCost]);
  return (
    <>
      <CheckOutTopBar />
            ...
            <div className='addressSectionMain'>
              <div className='addressBox'>
                <div className='addressBoxMain'>
                  <div className='addressBoxMainHead'>Select delivery address</div>
                  <div className='addaddressBox'>
                    <div className='addressSetBoxHead'>You have a saved address in this location</div>
                    <div className='addressSetBoxMain'>
                      <div className='deliveryHere'>
                        <div className='deliveryHereMain'>
                          <div className="deliveryHereIcon">
                          <img   className='deliveryHereImg' src={man} alt="Home>" />
                          <div className='clientInfo'> {clientName}</div>
                          </div>
                          <div className="deliveryHereIcon">
                          <img  className='deliveryHereImg'  src={map} alt="map" />
                           <div className='clientInfoAdd'> {clientAddress}</div>
                          </div>
                          <div className="deliveryHereIcon">
                           <img  className='deliveryHereImg'src={Contact} alt="Contact" />
                      ...
                      <div className='addAddress'>
                        <div className='addAddressMain'>
                          ...
                          <div className='addAddressImgBox'>
                           <img   className='addAddressImg'  src={AddressAdd} alt="Address Add" />
                           </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="product-list">
                <div className="product">
                  ...
                  <button className='CheckOutFirmDetails'>
                     <img className='checkOutFirmImage'src={`${API_URL}/uploads/${firmImage}`}/>
                     <span>
                    ...
                    <div className='billBox'>
                      <div className='bill'>
                        <div className='billSet'>
                          <div className='billSetUl'>
                            {Object.values(clickedProducts).map(product => {
                              const singleProductTotal = product.price * product.quantity; 
                              ...
                              return (
                                <div key={product._id} className='billSetLi'>
                                  ...
                                  {productCategory == 'veg' ? (
                                   <img className='cartProductvegimg' src={veg} alt="" />
                                   ) : ( <img className='cartProductvegimg' src={nonveg} alt="" />)}
                                
                                    <div className='cartProductProductName'>{product.productName}</div>
                                  </div>
                                  <div className='billButtonPrice'>
                                    ...
                                    <div className='moneysingleProductTotal'>
                                      <div className='rupee'><LiaRupeeSignSolid /></div>
                                      <div>
                                        {singleProductTotal} <div className='singleProductTotal'> ({product.price} x {product.quantity})</div>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <div className='applyCoupon'>
                          <div className="applyCouponOffer"><BiSolidOffer /></div><div>Apply Coupon</div>
                        </div>
                  ...
                  <div className='save'>
                    <div>Savings of</div>
                    <div><LiaRupeeSignSolid className='rupeeSave' /></div>
                    <div>10</div>
                  </div>
                  <div className='billNote'>
                    <div className='billNoteMain'>
                      <div className='billNoteHead'>Review your order and address details to avoid cancellations</div>
                      <div className='billNoteNote'>Note: If you cancel within 60 seconds of placing your order, a 100% refund will be issued. No refund for cancellations made after 60 seconds.</div>
                      <div className='billNoteNote'>Avoid cancellation as it leads to food wastage.</div>
                      <div className='billNoteCancellationPolicy'>Read cancellation policy</div>
                    </div>
                  </div>
                </div>
              </div>
