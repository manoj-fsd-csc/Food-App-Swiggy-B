...
function Chains() {
  ...
  />
    ...
    <div className='chainSectionTopTitle' ><h2>Top restaurant in Chennai</h2></div>
    <div className="btnSection">
      <button onClick={()=>handleScroller("left")}><HiOutlineChevronLeft className='btnSectionLeft'/></button>
      <button onClick={()=>handleScroller("right")}><HiOutlineChevronRight  className='btnSectionRight'/></button>
    </div>
    </div>
